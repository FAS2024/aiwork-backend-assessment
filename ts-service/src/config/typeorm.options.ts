...
import { CandidateDocumentsAndSummaries1720000000000 } from '../migrations/1720000000000-CandidateDocumentsAndSummaries';
...
export const getTypeOrmOptions = (
  ...
  migrations: [
    ...
    CandidateDocumentsAndSummaries1720000000000,
  ],
